...
//         <div className='w-[100%] md:gap-16 grid md:grid-cols-2 grid-cols-1 justify-between items-start md:my-16 my-5'>
//           {
//             blogData.map((blog)=>(
//           <div className='w-[100%] mb-16 md:mb-10 mx-auto z-10' key={blog.id}>
