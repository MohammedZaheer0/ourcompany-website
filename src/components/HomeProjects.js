...
const HomeProjects = () => {
  ...
  return (
    <div className='my-16'>
      ...
      <div className='w-[100%] lg:gap-16 grid md:grid-cols-2 grid-cols-1 justify-between items-center my-10'>
        <div className='justify-self-start relative overflow-hidden cursor-pointer' ref={parentRefs[0]}>
          ...
          <div className='w-[100%] mx-auto z-10'>
            ...
            <h2 className='homeparentHeading my-5 lg:text-2xl text-[1.2rem] font-bold'><span className='homeHeadingTag' ><Link to='/projects'>HLPR.com</Link></span></h2>
      ...
      <div className='w-[100%] lg:gap-16 grid md:grid-cols-2 grid-cols-1 justify-between items-center my-10'>
        ...
        <div className='justify-self-end relative overflow-hidden cursor-pointer order-1 md:order-2' ref={parentRefs[1]}>
          ...
          <div className='w-[100%] mx-auto z-10'>
            ...
            <h2 className='homeparentHeading my-5 lg:text-2xl text-[1.2rem] font-bold'><span className='homeHeadingTag' ><Link to='/projects'>GetBallpark.com</Link></span></h2>
      ...
      <div className='w-[100%] lg:gap-16 grid md:grid-cols-2 grid-cols-1 justify-between items-center md:my-10 my-16'>
        <div className='justify-self-start relative overflow-hidden cursor-pointer' ref={parentRefs[2]}>
          ...
          <div className='w-[100%] mx-auto z-10'>
            ...
            <h2 className='homeparentHeading my-5 lg:text-2xl text-[1.2rem] font-bold'><span className='homeHeadingTag' ><Link to='/projects'>GetAwair.com</Link></span></h2>
        ...
        <div className='justify-self-end text-center md:w-[80%] w-[90%] text-[#D35400]'>
          <h2 className='homeparentHeading my-5 lg:text-3xl text-[1.3rem] font-bold flex justify-center gap-3 items-center'><span className='UnderlineStyle' ><Link to='/projects'>View More Projects</Link></span><FaArrowRightLong /></h2>
        </div>
      </div>
    </div>
  )
