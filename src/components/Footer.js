...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    if (!parentElement) return; // Return early if parentRef is null
    ...
    <footer className="md:w-[80%] w-[90%] mx-auto">
      {location.pathname !== "/contact" ?
        <div className="w-[100%] my-24 grid grid-cols-2 justify-between items-center">
          <div className="">
            <h1 className="xl:text-5xl lg:text-4xl md:text-3xl text-[1.5rem] font-bold">
          ...
          <div
            ref={parentRef}
            className="relative h-[100%] w-[100%] flex justify-end overflow-hidden md:overflow-visible"
          >
            <div
              ref={rectangleRef}
              className="absolute top-0 right-24 rotate-45 h-[150px] w-[150px] border-[2px] border-[gray]"
            ></div>
            <div
              ref={circleRef}
              className="absolute top-0 right-0 h-[150px] w-[150px] rounded-full border-[2px] border-[gray]"
            ></div>
          </div>
        </div>
        :''
      ...
      <div className="md:my-20 mt-20 mb-10">
        <h3 className="lg:w-[50%] md:w-[70%] w-[100%] font-medium text-[20px] my-7">
          Simple Focus is a happy team of digital designers and developers.
          We’re fully distributed, with concentrations in Memphis and
          Chattanooga, Tennessee and employees collaborating across seven time
          zones.
        </h3>

        <div className="grid md:grid-cols-2 grid-cols-1 justify-between items-center">
          <div className="order-2 md:order-1 w-[100%]">
            <p className="my-8 font-bold text-[18px] md:text-[15px] lg:text-[18px]">
              We are also behind
              <span className="text-[#D35400] cursor-pointer hover:text-[#724223]">
                {" "}
                Audience Ops,{" "}
              </span>
              <span className="text-[#D35400] cursor-pointer hover:text-[#724223]">
          ...
          <div className="w-[100%] h-[100%] flex md:justify-end justify-start gap-10 items-center order-1 md:order-2">
            <img
              src="/assets/footer500.png"
              alt="footer500"
              className="w-[70px] lg:w-[100px] h-[70px] lg:h-[100px]"
            />
            <img
              src="/assets/footer360.png"
              alt="footer360"
              className="w-[70px] lg:w-[100px] h-[70px] lg:h-[100px]"
            />
          </div>
